...
export function StatsCard({
  ...
  return (
    <motion.div
      ...
      className="bg-white p-4 sm:p-5 rounded-2xl shadow-sm border border-gray-100/80 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 overflow-hidden relative"
    >
      <div className="absolute inset-0 bg-linear-to-br from-gray-50/50 to-transparent pointer-events-none" />
      <div
        className={`p-2 sm:p-3 rounded-xl bg-linear-to-br ${gradient} ${shadow} shrink-0`}
      >
